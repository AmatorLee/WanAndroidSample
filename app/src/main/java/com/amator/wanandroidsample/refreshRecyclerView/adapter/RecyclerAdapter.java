package com.amator.wanandroidsample.refreshRecyclerView.adapter;
...
public abstract class RecyclerAdapter<T> extends RecyclerView.Adapter<BaseViewHolder<T>> implements IHandler {
    ...
    public void setItemClick(final BaseViewHolder holder, final T data) {
        holder.itemView.setOnClickListener(null);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                holder.onItemViewClick(data);
            }
        });
    }
