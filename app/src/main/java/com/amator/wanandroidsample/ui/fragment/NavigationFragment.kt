...
import com.amator.wanandroidsample.mvp.presenter.impl.NaviPresenterImpl
import com.amator.wanandroidsample.mvp.view.NaviView

/**
 * Created by AmatorLee on 2018/4/26.
 */
class NavigationFragment : BaseFragment<NaviPresenterImpl>(), NaviView {
    ...
    override fun getLayoutId(): Int = R.layout.fragment_navi
